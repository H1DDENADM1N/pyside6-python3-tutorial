...
![数据库_Run_Sql.py_](../assets/数据库_Run_Sql.py_.png)
...
下载并解压 [ecdict-sqlite-28.zip](https://github.com/skywind3000/ECDICT/releases)，得到`stardict.db`

#### 设计界面

在 Qt Desinger 设计词典界面
...
![简易词典_Run_Dict.py_](../assets/简易词典_Run_Dict.py_.png)

### 组合框（QComboBox）

#### 不允许添加新条目，但允许编辑的组合框示例
...
![组合框_MyComboBoxDemo_Editable_NotAllowAddItem.py_](../assets/组合框_MyComboBoxDemo_Editable_NotAllowAddItem.py_.png)
